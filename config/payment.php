...
return [
    ...
    */
    'drivers' => [
        ...
        'zarinpal' => [
            ...
            'merchantId' => '2ba8e896-6b15-11e9-9d52-000c29344814',
            'callbackUrl' => 'http://localhost:8001/payment/callback',
        ...
        'llccg' => [
            "terminalId" => "bct01",
            "vendorId" => "BCCTest",
            "vendorPass" => "G6t4kL0J5t",
            "merchantId" => "160001",
            "merchantIp" => "37.152.178.208",
            "terminalPass" => "2030",
            "userKey4pin" => "yULo96SY7outrt6r5",
            "userKey" => "T5Er5TjwHuwZ",
            "cardType" => "IRCCG",
            "apiTestHttp" => "www.irccg1.com/appapi/Eaccg_Global_Gateway_test.asp",
            "apiTestHttps" => "HTTPS://www.irccg1.com/api/Eaccg_Global_Gateway_test.asp",
            "apiPrimaryHttp" => "HTTPS://www.irccg1.com/api/Eaccg_Global_Gateway.asp",
            "apiPrimaryHttps" => "HTTP://www.irccg1.com/aapapi/Eaccg_Global_Gateway.asp",
        ],
    ],
    ...
    */
    'map' => [
        ...
        'llccg' => \App\Services\CustomersClub\LLCCGPaymentDriver::class,
    ]
];
